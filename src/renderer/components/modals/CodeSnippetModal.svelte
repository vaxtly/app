...
{#if open}
  ...
  >
    ...
    <!-- Modal -->
    <div class="relative z-10 flex max-h-[80vh] w-[680px] flex-col rounded-lg border border-surface-700 bg-surface-900 shadow-xl">
      <!-- Header -->
      <div class="flex shrink-0 items-center justify-between border-b border-surface-700 px-4 py-3">
      ...
      <!-- Language tabs -->
      <div class="flex shrink-0 gap-1 border-b border-surface-700 px-4">
      ...
      <!-- Footer -->
      <div class="flex shrink-0 items-center justify-end gap-2 border-t border-surface-700 px-4 py-3">
        <button
